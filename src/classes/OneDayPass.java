...
public class OneDayPass extends Bilet {
    ...
    public OneDayPass(String eventName, String cumparator, LocalDate ziAcces, boolean includeCamping, String tip, String codplata) {
        super(eventName, cumparator, tip, codplata);
